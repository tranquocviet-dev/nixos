...
(let* ((bg "#1c1917")
      (err "#de6e7c")
      (err-container "#891120")
      (on-background "#b4bdc3")
      (on-err "#1c1917")
      (on-err-container "#f6d5d9")
      (on-primary "#1c1917")
      (on-primary-container "#e3e6e8")
      (on-secondary "#1c1917")
      (on-secondary-container "#e4e6e7")
      (on-surface "#b4bdc3")
      (on-surface-variant "#888f94")
      (on-tertiary "#1c1917")
      (on-tertiary-container "#e7e5e4")
      (outline-color "#888f94")
      (outline-variant "#62696d")
      (primary "#b4bdc3")
      (primary-container "#49677c")
      (secondary "#888f94")
      (secondary-container "#2a373f")
      (shadow "#1c1917")
      (surface "#1c1917")
      (surface-container "#403833")
      (surface-container-high "#4b423c")
      (surface-container-highest "#574c45")
      (surface-container-low "#2e2825")
      (surface-container-lowest "#231f1c")
      (surface-variant "#403833")
      (tertiary "#9f948f")
      (tertiary-container "#4c3830")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#9f948f")
      (on-success "#1c1917")
      (success-container "#4c3830")
      (on-success-container "#e7e5e4")
      ;; Map fixed colors to regular colors
      (primary-fixed "#b4bdc3")
      (primary-fixed-dim "#49677c")
      (secondary-fixed "#888f94")
      (secondary-fixed-dim "#2a373f")
      (tertiary-fixed "#9f948f")
      (tertiary-fixed-dim "#4c3830")
      (on-primary-fixed "#1c1917")
      (on-primary-fixed-variant "#e3e6e8")
      (on-secondary-fixed "#1c1917")
      (on-secondary-fixed-variant "#e4e6e7")
      (on-tertiary-fixed "#1c1917")
      (on-tertiary-fixed-variant "#e7e5e4")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#b4bdc3")
      (inverse-primary "#b4bdc3")
