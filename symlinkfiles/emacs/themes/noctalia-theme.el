...
(let* ((bg "#32302f")
      (err "#ea6962")
      (err-container "#930e07")
      (on-background "#ddc7a1")
      (on-err "#32302f")
      (on-err-container "#f9d4d2")
      (on-primary "#32302f")
      (on-primary-container "#ecefdc")
      (on-secondary "#32302f")
      (on-secondary-container "#f9e1d2")
      (on-surface "#ddc7a1")
      (on-surface-variant "#d4be98")
      (on-tertiary "#32302f")
      (on-tertiary-container "#e1ecdf")
      (outline-color "#827770")
      (outline-variant "#59514d")
      (primary "#a9b665")
      (primary-container "#464f1a")
      (secondary "#e78a4e")
      (secondary-container "#7d3406")
      (shadow "#282828")
      (surface "#32302f")
      (surface-container "#3c3836")
      (surface-container-high "#474240")
      (surface-container-highest "#514c49")
      (surface-container-low "#373432")
      (surface-container-lowest "#343130")
      (surface-variant "#3c3836")
      (tertiary "#89b482")
      (tertiary-container "#2f5c27")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#89b482")
      (on-success "#32302f")
      (success-container "#2f5c27")
      (on-success-container "#e1ecdf")
      ;; Map fixed colors to regular colors
      (primary-fixed "#a9b665")
      (primary-fixed-dim "#464f1a")
      (secondary-fixed "#e78a4e")
      (secondary-fixed-dim "#7d3406")
      (tertiary-fixed "#89b482")
      (tertiary-fixed-dim "#2f5c27")
      (on-primary-fixed "#32302f")
      (on-primary-fixed-variant "#ecefdc")
      (on-secondary-fixed "#32302f")
      (on-secondary-fixed-variant "#f9e1d2")
      (on-tertiary-fixed "#32302f")
      (on-tertiary-fixed-variant "#e1ecdf")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#ddc7a1")
      (inverse-primary "#a9b665")
