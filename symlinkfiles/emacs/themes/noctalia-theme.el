...
(let* ((bg "#282a36")
      (err "#ff5555")
      (err-container "#a20000")
      (on-background "#f8f8f2")
      (on-err "#282a36")
      (on-err-container "#ffcccc")
      (on-primary "#282a36")
      (on-primary-container "#e1cffc")
      (on-secondary "#4e1d32")
      (on-secondary-container "#ffd9ee")
      (on-surface "#f8f8f2")
      (on-surface-variant "#d6d8e0")
      (on-tertiary "#003543")
      (on-tertiary-container "#1a3d45")
      (outline-color "#6d728b")
      (outline-variant "#4b4f60")
      (primary "#bd93f9")
      (primary-container "#5a00d9")
      (secondary "#ff79c6")
      (secondary-container "#c60071")
      (shadow "#282a36")
      (surface "#282a36")
      (surface-container "#44475a")
      (surface-container-high "#4d5066")
      (surface-container-highest "#565971")
      (surface-container-low "#363848")
      (surface-container-lowest "#2d2f3d")
      (surface-variant "#44475a")
      (tertiary "#8be9fd")
      (tertiary-container "#00b0d5")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#8be9fd")
      (on-success "#003543")
      (success-container "#00b0d5")
      (on-success-container "#1a3d45")
      ;; Map fixed colors to regular colors
      (primary-fixed "#bd93f9")
      (primary-fixed-dim "#5a00d9")
      (secondary-fixed "#ff79c6")
      (secondary-fixed-dim "#c60071")
      (tertiary-fixed "#8be9fd")
      (tertiary-fixed-dim "#00b0d5")
      (on-primary-fixed "#282a36")
      (on-primary-fixed-variant "#e1cffc")
      (on-secondary-fixed "#4e1d32")
      (on-secondary-fixed-variant "#ffd9ee")
      (on-tertiary-fixed "#003543")
      (on-tertiary-fixed-variant "#1a3d45")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f8f8f2")
      (inverse-primary "#bd93f9")
      (inverse-surface "#282a36")
