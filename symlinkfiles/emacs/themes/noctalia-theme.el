...
(let* ((bg "#1e2127")
      (err "#e06c75")
      (err-container "#8a0f19")
      (on-background "#cdd4e1")
      (on-err "#1e2127")
      (on-err-container "#f6d5d7")
      (on-primary "#1e2127")
      (on-primary-container "#d1e8fa")
      (on-secondary "#1e2127")
      (on-secondary-container "#eed6f5")
      (on-surface "#cdd4e1")
      (on-surface-variant "#61afef")
      (on-tertiary "#1e2127")
      (on-tertiary-container "#e4efdc")
      (outline-color "#646b79")
      (outline-variant "#41464f")
      (primary "#61afef")
      (primary-container "#03569b")
      (secondary "#c678dd")
      (secondary-container "#72158e")
      (shadow "#181a1f")
      (surface "#1e2127")
      (surface-container "#282c34")
      (surface-container-high "#313640")
      (surface-container-highest "#3a404b")
      (surface-container-low "#23262d")
      (surface-container-lowest "#202329")
      (surface-variant "#282c34")
      (tertiary "#98c379")
      (tertiary-container "#3f6920")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#98c379")
      (on-success "#1e2127")
      (success-container "#3f6920")
      (on-success-container "#e4efdc")
      ;; Map fixed colors to regular colors
      (primary-fixed "#61afef")
      (primary-fixed-dim "#03569b")
      (secondary-fixed "#c678dd")
      (secondary-fixed-dim "#72158e")
      (tertiary-fixed "#98c379")
      (tertiary-fixed-dim "#3f6920")
      (on-primary-fixed "#1e2127")
      (on-primary-fixed-variant "#d1e8fa")
      (on-secondary-fixed "#1e2127")
      (on-secondary-fixed-variant "#eed6f5")
      (on-tertiary-fixed "#1e2127")
      (on-tertiary-fixed-variant "#e4efdc")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#cdd4e1")
      (inverse-primary "#61afef")
      (inverse-surface "#1e2127")
