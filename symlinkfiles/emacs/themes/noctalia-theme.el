...
(let* ((bg "#1d1f21")
      (err "#cc6666")
      (err-container "#641b1b")
      (on-background "#c5c8c6")
      (on-err "#1d1f21")
      (on-err-container "#f2d9d9")
      (on-primary "#1d1f21")
      (on-primary-container "#dde6ee")
      (on-secondary "#1d1f21")
      (on-secondary-container "#e9e0eb")
      (on-surface "#c5c8c6")
      (on-surface-variant "#969896")
      (on-tertiary "#1d1f21")
      (on-tertiary-container "#f6e2d5")
      (outline-color "#656a70")
      (outline-variant "#414448")
      (primary "#81a2be")
      (primary-container "#294964")
      (secondary "#b294bb")
      (secondary-container "#5d3469")
      (shadow "#1d1f21")
      (surface "#1d1f21")
      (surface-container "#282a2e")
      (surface-container-high "#313439")
      (surface-container-highest "#3b3e44")
      (surface-container-low "#222427")
      (surface-container-lowest "#1f2123")
      (surface-variant "#282a2e")
      (tertiary "#de935f")
      (tertiary-container "#763c14")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#de935f")
      (on-success "#1d1f21")
      (success-container "#763c14")
      (on-success-container "#f6e2d5")
      ;; Map fixed colors to regular colors
      (primary-fixed "#81a2be")
      (primary-fixed-dim "#294964")
      (secondary-fixed "#b294bb")
      (secondary-fixed-dim "#5d3469")
      (tertiary-fixed "#de935f")
      (tertiary-fixed-dim "#763c14")
      (on-primary-fixed "#1d1f21")
      (on-primary-fixed-variant "#dde6ee")
      (on-secondary-fixed "#1d1f21")
      (on-secondary-fixed-variant "#e9e0eb")
      (on-tertiary-fixed "#1d1f21")
      (on-tertiary-fixed-variant "#f6e2d5")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#c5c8c6")
      (inverse-primary "#81a2be")
      (inverse-surface "#1d1f21")
