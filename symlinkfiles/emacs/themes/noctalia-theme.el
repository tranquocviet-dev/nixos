...
(let* ((bg "#2e3440")
      ...
      (outline-color "#727d94")
      (outline-variant "#505869")
      (primary "#8fbcbb")
      (primary-container "#316867")
      (secondary "#88c0d0")
      (secondary-container "#286b7e")
      (shadow "#2e3440")
      (surface "#2e3440")
