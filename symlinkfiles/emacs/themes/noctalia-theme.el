...
(let* ((bg "#202224")
      (err "#da4453")
      (err-container "#620a13")
      (on-background "#fcfcfc")
      (on-err "#141618")
      (on-err-container "#f7d4d8")
      (on-primary "#141618")
      (on-primary-container "#d1ecfa")
      (on-secondary "#141618")
      (on-secondary-container "#cfe9fc")
      (on-surface "#fcfcfc")
      (on-surface-variant "#a1a9b1")
      (on-tertiary "#141618")
      (on-tertiary-container "#eadcef")
      (outline-color "#707d8a")
      (outline-variant "#4e5760")
      (primary "#3daee9")
      (primary-container "#034b70")
      (secondary "#1d99f3")
      (secondary-container "#00365e")
      (shadow "#272c31")
      (surface "#202224")
      (surface-container "#292d32")
      (surface-container-high "#32373d")
      (surface-container-highest "#3b4148")
      (surface-container-low "#24272b")
      (surface-container-lowest "#212426")
      (surface-variant "#292d32")
      (tertiary "#9b59b6")
      (tertiary-container "#391547")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#9b59b6")
      (on-success "#141618")
      (success-container "#391547")
      (on-success-container "#eadcef")
      ;; Map fixed colors to regular colors
      (primary-fixed "#3daee9")
      (primary-fixed-dim "#034b70")
      (secondary-fixed "#1d99f3")
      (secondary-fixed-dim "#00365e")
      (tertiary-fixed "#9b59b6")
      (tertiary-fixed-dim "#391547")
      (on-primary-fixed "#141618")
      (on-primary-fixed-variant "#d1ecfa")
      (on-secondary-fixed "#141618")
      (on-secondary-fixed-variant "#cfe9fc")
      (on-tertiary-fixed "#141618")
      (on-tertiary-fixed-variant "#eadcef")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#fcfcfc")
      (inverse-primary "#3daee9")
      (inverse-surface "#202224")
