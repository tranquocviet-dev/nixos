...
(let* ((bg "#1e1e2e")
      ...
      (on-err "#11111b")
      (on-err-container "#ffd6e1")
      (on-primary "#11111b")
      (on-primary-container "#ddf5ff")
      (on-secondary "#11111b")
      (on-secondary-container "#cee0fd")
      (on-surface "#cdd6f4")
      (on-surface-variant "#a3b4eb")
      (on-tertiary "#11111b")
      (on-tertiary-container "#102a2f")
      (outline-color "#646883")
      (outline-variant "#434658")
      (primary "#74c7ec")
      (primary-container "#0875a6")
      (secondary "#89b4fa")
      (secondary-container "#004fd1")
      (shadow "#11111b")
      (surface "#1e1e2e")
      ...
      (tertiary "#89dceb")
      (tertiary-container "#0e9ab4")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#89dceb")
      (on-success "#11111b")
      (success-container "#0e9ab4")
      (on-success-container "#102a2f")
      ;; Map fixed colors to regular colors
      (primary-fixed "#74c7ec")
      (primary-fixed-dim "#0875a6")
      (secondary-fixed "#89b4fa")
      (secondary-fixed-dim "#004fd1")
      (tertiary-fixed "#89dceb")
      (tertiary-fixed-dim "#0e9ab4")
      (on-primary-fixed "#11111b")
      (on-primary-fixed-variant "#ddf5ff")
      (on-secondary-fixed "#11111b")
      (on-secondary-fixed-variant "#cee0fd")
      (on-tertiary-fixed "#11111b")
      (on-tertiary-fixed-variant "#102a2f")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#cdd6f4")
      (inverse-primary "#74c7ec")
